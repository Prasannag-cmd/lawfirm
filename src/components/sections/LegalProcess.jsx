...
export default function LegalProcess() {
  ...
  return (
    <section id="process" className="py-[70px] md:py-[90px] lg:py-[120px] bg-cream/10 relative overflow-hidden border-t border-silver/30">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <ScrollReveal animation="fadeUp" className="max-w-5xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm border border-silver/50 rounded-3xl overflow-hidden shadow-[0_8px_30px_rgba(44,53,46,0.04)]">
            ...
            <div className="hidden sm:grid grid-cols-12 gap-4 px-8 py-5 border-b border-silver/40 bg-cream/20 font-inter text-xs text-text-secondary uppercase tracking-widest font-bold">
                ...
                return (
                  <div key={idx} className={`transition-all duration-300 ${isExpanded ? 'bg-cream/10' : 'hover:bg-cream/5'}`}>
                    ...
                    <div 
                      ...
                      className="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4 px-6 sm:px-8 py-5 items-center cursor-pointer select-none"
                    >
                      {/* Day & Time */}
                      ...
                      <div className="col-span-1 sm:col-span-4 flex flex-col justify-center">
                      ...
                      {/* Expand Chevron Icon */}
                      <div className="col-span-1 sm:col-span-2 flex justify-between sm:justify-end items-center mt-2 sm:mt-0">
                        <span className="sm:hidden font-inter text-xs text-text-secondary/70">Click to view details</span>
                    ...
                    <AnimatePresence initial={false}>
                      {isExpanded && (
                        ...
                        >
                          <div className="px-6 sm:px-8 py-5 grid sm:grid-cols-2 gap-6 text-sm font-inter">
